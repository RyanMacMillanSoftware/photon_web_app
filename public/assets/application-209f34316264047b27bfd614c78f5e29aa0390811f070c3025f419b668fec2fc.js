...
(function() {
  jQuery(function() {
    return $(document).ready(function() {
      var currentdate, select, select2, selection, selection2, time;
      ...
      select.change(function() {
        ...
        if (selection === "Guest") {
          $("#guest_name_id").show();
          return $("#time_punch_buddy option[value='']").remove();
        } else {
          $("#guest_name_id").hide();
          $("#time_punch_buddy option[value='']").remove();
          return $("#time_punch_buddy").append('<option value="">N/A (Staff Only)</option>');
        }
      });
      select2 = $("#time_punch_buddy");
      return select2.change(function() {
        selection2 = select2.val();
        if (selection2 === "Guest") {
          return $("#guest_buddy_name_id").show();
        } else {
          return $("#guest_buddy_name_id").hide();
        }
      });
    });
  });
